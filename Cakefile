...
task 'dev', 'start dev env', ->
  ...
  # JST templates for eco
  # options = ['assets/templates','-p', '-i', 'JST', '-o', 'assets/templates']
  # cmd = which.sync 'eco'
  # eco = spawn cmd, options
  # eco.stdout.pipe process.stdout
  # eco.stderr.pipe process.stderr
  # watch_js
...
task 'debug', 'start debug env', ->
  ...
  chrome = spawn chrome_cmd, chrome_options
